...
// ```
// can be used on instances and automatically escape depending on the context
// ```java
...
// ## <img src="images/java-record.jpg" alt="record disc" width="500"/>
...
// ## <img src="images/java-reflection.png" alt="Duke and its reflection in the mirror" width="500"/>
...
// ## <img src="images/duke-sealed.jpg" alt="Duke with a sealed document" width="500"/>
